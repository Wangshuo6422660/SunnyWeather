...
// 彩云天气返回的数据中，天气情况都是一些诸如CLOUDY、WIND之类的天气代码，我们需要编写一个转换函数
// 将这些天气代码转换成一个Sky对象
// Sky类作为数据模型，它包含了info、icon、bg这三个字段，分别代表该天气情况所对应的文字、图标、背景
...
private val sky = mapOf(
    ...
    "PARTLY_CLOUDY_DAY" to Sky("多云", R.drawable.ic_partly_cloud_day, R.drawable.bg_cloudy),
    "PARTLY_CLOUDY_NIGHT" to Sky("多云", R.drawable.ic_partly_cloud_night, R.drawable.bg_cloudy),
